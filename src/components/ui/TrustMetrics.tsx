...
export default function TrustMetrics() {
  return (
    <>
      ...
      {/* Attribution — sourcing the numbers removes the "invented metric" credibility gap */}
      <FadeIn>
        <p className="mt-8 mx-auto max-w-2xl text-center text-xs sm:text-sm text-text-muted/80 text-balance">
          Médias de projetos de referência entregues a clínicas. Os números
          variam conforme o porte e a maturidade digital de cada operação.
        </p>
      </FadeIn>
    </>
  );
