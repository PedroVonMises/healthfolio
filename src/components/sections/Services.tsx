...
const services = [
  ...
  },
  {
    ...
    description:
      "Não arrisque a reputação da sua clínica. Toda a arquitetura digital é desenhada com criptografia de ponta a ponta, garantindo a privacidade total dos dados dos seus pacientes.",
    icon: <Lock className="h-6 w-6 text-primary" strokeWidth={1.5} />,
    className:
      "md:col-span-1 md:row-span-1 bg-gradient-to-br from-bg to-primary-highlight/10",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      "Diferencie-se da concorrência oferecendo um ambiente seguro onde o paciente acessa resultados de exames, laudos e histórico médico na palma da mão, aumentando a fidelização.",
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <StaggerContainer
            className="grid max-w-xl grid-cols-1 gap-6 md:grid-cols-3 md:auto-rows-[1fr] lg:max-w-none"
            staggerDelay={0.1}
          >
