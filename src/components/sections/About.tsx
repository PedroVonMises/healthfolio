      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center">
          <div className="lg:pr-8 lg:pt-4">
            <StaggerContainer className="lg:max-w-lg" staggerDelay={0.12}>
              <FadeIn>
              ...
              <FadeIn>
                <p className="mt-6 text-base leading-7 text-text-muted">
                  Sou Pedro Augusto, dev front-end dedicado exclusivamente a
                  digitalizar o setor de saúde na Grande Vitória.
                </p>
              </FadeIn>
              <FadeIn>
                <p className="mt-4 text-base leading-7 text-text-muted">
                  Ao observar o caos administrativo em recepções de clínicas,
                  percebi que a tecnologia genérica falha com os médicos. Minha
                  missão é traduzir código complexo em eficiência operacional:
                  reduzindo faltas, protegendo dados (LGPD) e criando a
                  experiência fluida que pacientes de alto ticket exigem.
                  Atendimento presencial e consultivo para clínicas de Vitória,
                  Vila Velha e região.
                </p>
              </FadeIn>
              <FadeIn>
